...
cli.responders.moreUserInfo = function (str) {
  ...
  if (userId) {
    ...
    console.log(
      "Please specify userId to use this command. type help/man to get information"
    );
  }
};
// List checks
...
cli.responders.moreCheckInfo = function (str) {
  ...
  if (checkId) {
    ...
    console.log(
      "Please specify checkId to use this command. type help/man to get information"
    );
  }
};
// Help / Man
...
cli.responders.moreLogInfo = function (str) {
  ...
  if (logFileName) {
    ...
    console.log(
      "Please specify fileName to use this command. type help/man to get information"
    );
  }
};
